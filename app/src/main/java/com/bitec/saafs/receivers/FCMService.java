...
import com.bitec.saafs.ui.activities.lottie.FestivalActivity;
...
import com.bitec.saafs.utils.NotificationUtil;
    ...
    private void handleDataMessage(RemoteMessage remoteMessage) {
        ...
        switch (click_action) {
            ...
            case "com.bitec.saafs.TARGET_FRIENDREQUEST":
                ...
                break;
            case "com.bitec.saafs.TARGET_ACCEPTED":

                resultIntent = new Intent(getApplicationContext(), FriendProfile.class);

                break;
            case "com.bitec.saafs.TARGET_DECLINED":
            ...
            case "com.bitec.saafs.TARGET_LIKE":
                ...
                break;
            case "com.bitec.saafs.TARGET_FESTIVAL":
