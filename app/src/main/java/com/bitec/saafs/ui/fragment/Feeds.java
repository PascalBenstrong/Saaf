...
import com.bitec.saafs.adapters.PostsAdapter;
import com.bitec.saafs.adapters.PostsAdapter_v19;
...
import static com.bitec.saafs.ui.activities.MainActivity.showFragment;
...
public class Feeds extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPostsRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                boolean reachedBottom=!recyclerView.canScrollVertically(0);
                if(reachedBottom){
                    loadMorePost();
    ...
    public void checkFriendRequest(){
        ...
        mFirestore.collection("Users")
                ...
                .addSnapshotListener ( MainActivity.activity.getActivity (), (queryDocumentSnapshots, e) -> {
                    ...
                    if(!queryDocumentSnapshots.isEmpty()){
                        try {
                            ...
                            request_alert.setOnClickListener ( v -> {
                                if (MainActivity.activity.getCurrentuser ().isEmailVerified ()) {
                                    MainActivity.activity.getToolbar ().setTitle("Manage Friends");
                                    try {
