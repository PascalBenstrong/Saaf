package com.bitec.saafs.ui.activities.friends;
...
import com.bitec.saafs.ui.activities.lottie.SendingActivity;
import com.bitec.saafs.ui.activities.notification.ImagePreview;
import com.bitec.saafs.ui.activities.notification.ImagePreviewSave;
...
import static com.bitec.saafs.utils.Config.random;
...
public class SendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirestore.collection("Users").document(user_id).get().addOnSuccessListener (
                documentSnapshot -> {
        ...
        mFirestore.collection("Users").document(current_id).get().addOnSuccessListener (
                documentSnapshot -> {
                ...
                new MaterialDialog.Builder(this)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                UCrop.of(imageUri, Uri.fromFile(new File(getCacheDir(), String.format("saaf_%s.png", random()))))
                                        .withOptions(options)
