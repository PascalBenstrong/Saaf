package com.bitec.saafs.ui.activities.post;
...
import com.bitec.saafs.adapters.UploadListAdapter;
            ...
            if (resultCode == RESULT_OK && data != null) {
                ...
                if(!imagesList.isEmpty()){
                    ...
                    for(int i=0;i<imagesList.size();i++) {
                        ...
                        final int finalI = i;
                        fileToUpload.putFile(fileUri).addOnSuccessListener(taskSnapshot -> fileToUpload.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            @Override
