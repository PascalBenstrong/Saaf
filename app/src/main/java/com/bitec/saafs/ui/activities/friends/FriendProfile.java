                            ...
                            accept.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    new BottomDialog.Builder(rootView.getContext())
                                            .setTitle("Accept Follower Request")
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            add_friend.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    new BottomDialog.Builder(rootView.getContext())
                                            .setTitle("Add Following ")
                                            .setContent("Are you sure do you want to send follow request to " + friend_name +" ?")
                                            .setPositiveText("Yes")
                                            .setPositiveBackgroundColorResource(R.color.colorAccentt)
                                            .setNegativeText("No")
                                            .onPositive(new BottomDialog.ButtonCallback() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            remove_friend.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    new BottomDialog.Builder(rootView.getContext())
                                            .setTitle("Remove Follow ")
                                            .setContent("Are you sure do you want to remove " + friend_name + " from your follow list?")
                                            .setPositiveText("Yes")
                                            .setPositiveBackgroundColorResource(R.color.colorAccentt)
                                            .setNegativeText("No")
                                            .onPositive(new BottomDialog.ButtonCallback() {
